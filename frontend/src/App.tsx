...
const navItems: NavItem[] = [
  ...
  { id: 'handover', label: '인수인계', group: '업무' },
  { id: 'assistant', label: 'AI에게 물어보기', group: '업무', requiredPermission: 'llm:chat' },
  { id: 'personnel', label: '인사관리', group: '회사 관리', requiredPermission: 'admin:users' },
  { id: 'work-schedule', label: '업무 배정', group: '회사 관리', requiredPermission: 'memory:write' },
  { id: 'hiring', label: '채용/면접', group: '회사 관리', requiredPermission: 'memory:write' },
  { id: 'work-architecture', label: '프로세스 설계', group: '회사 관리', requiredPermission: 'memory:write' },
  { id: 'dashboard', label: '회사 운영 설정', group: '회사 관리', requiredPermission: 'memory:write' },
  { id: 'work-memory', label: '회사 메모리', group: '회사 관리', requiredPermission: 'memory:write' },
  ...
  { id: 'progress', label: '진행 로그', group: '시스템 관리', requiredPermission: 'admin:users' },
  { id: 'skills', label: '스킬 실행', group: '시스템 관리', requiredPermission: 'admin:users' },
  { id: 'chat', label: '코딩 에이전트 계획서', group: '시스템 관리', requiredPermission: 'admin:users' },
...
export default function App() {
  ...
  function renderPage() {
    ...
    if (activePage === 'messenger') {
      return <MessengerPage user={currentUser!} />;
    }
